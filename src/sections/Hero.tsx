...
<div className="flex flex-col lg:flex-row gap-20 mb-20 mt-20">
    <div className="flex flex-col md:mb-0 gap-10 md:gap-15 md:flex-1">
        ...
        <div className=" flex gap-7 md:gap-10 flex-col">
            <h1 className="text-3xl md:text-5xl head font-bold tracking-wide dark:text-white">Master New Skills with <span className="text-[#5300b7] dark:text-[#d3bbff]">Industry-Recognized </span> Certifications</h1>
    ...
    <div className="relative md:flex-1 ">
        ...
        <div className="absolute bottom-4  z-0 flex gap-2 items-center right-4  left-4 bg-white/90 dark:bg-[#1b2337]/90 dark:border dark:border-white/10 p-5 rounded-2xl">
            ...
            <div >
                ...
                <p className="font-semibold text-lg dark:text-white">Verified Certificates</p>
                <p className="dark:text-[#cac4cf] text-sm md:text-md">Endorsed by top universities & companies</p>
