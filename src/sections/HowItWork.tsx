const HowItWork = () => {
  const steps = [
    {
      ...
      desc: "Browse our catalog of 500+ specialized tracks curated for modern industries.",
    },
    {
      id: "02",
      title: "Learn and complete",
      desc: "Dive into high-quality video lessons, dynamic interactive labs, and assignments.",
    },
    {
      id: "03",
      title: "Take the exam",
      desc: "Schedule your secure validation assessment whenever you feel confident and ready.",
    },
    {
      id: "04",
      title: "Get certified",
      desc: "Download your verified digital credentials and showcase them with your network.",
    },
  ];
  ...
  return (
    <div
      id="HowItWork"
      className="bg-transparent p-6 py-12 md:p-16 max-w-7xl mx-auto"
    >
      <div className="flex flex-col md:flex-row mb-12 gap-5 items-start justify-between">
        <div className="flex gap-2 flex-col max-w-2xl">
          <h2 className="text-3xl lg:text-4xl font-bold tracking-tight text-gray-900 dark:text-white">
            Your Path to{" "}
            <span className="text-[#16423C] dark:text-[#a9f5a8]">Success</span>
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {steps.map((step) => (
          <div
            key={step.id}
            className="group relative p-8 rounded-3xl border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900/50 hover:border-[#16423C] dark:hover:border-[#a9f5a8] transition-all duration-300 shadow-xs hover:shadow-xl"
          >
