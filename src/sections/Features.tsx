    ...
    <div className="bg-[#16423C] p-6 md:p-16" id="features">
      <div className="mb-12 flex justify-center items-center flex-col text-center">
        <p className="text-gray-100 text-base md:text-lg max-w-2xl dark:text-gray-100">
          Access a premium suite of learning tools designed to help you master
          new domains quickly and effectively.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        <div className="group bg-white dark:bg-slate-800/40 border border-gray-100 dark:border-slate-700/30 rounded-3xl p-8 shadow-xs flex flex-col justify-between duration-300 hover:-translate-y-1 hover:shadow-md">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
              Learn directly from industry veterans and academic leaders who
        ...
        <div className="group bg-white dark:bg-slate-800/40 border border-gray-100 dark:border-slate-700/30 rounded-3xl p-8 shadow-xs flex flex-col justify-between duration-300 hover:-translate-y-1 hover:shadow-md">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
              Life is busy. Study whenever and wherever it suits you, without
              any fixed deadlines or rigid attendance blocks.
            </p>
          </div>
        </div>
        ...
        <div className="group bg-white dark:bg-slate-800/40 border border-gray-100 dark:border-slate-700/30 rounded-3xl p-8 shadow-xs flex flex-col justify-between duration-300 hover:-translate-y-1 hover:shadow-md">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
              Validate your knowledge with rigorous, comprehensive exams
              designed to test deep situational understanding.
            </p>
          </div>
        </div>
        ...
        <div className="group bg-white dark:bg-slate-800/40 border border-gray-100 dark:border-slate-700/30 rounded-3xl p-8 shadow-xs flex flex-col justify-between duration-300 hover:-translate-y-1 hover:shadow-md">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
              Get graded immediately. No more waiting days to find out how you
              performed on your certification exam.
            </p>
          </div>
        </div>
        ...
        <div className="group bg-white dark:bg-slate-800/40 border border-gray-100 dark:border-slate-700/30 rounded-3xl p-8 shadow-xs flex flex-col justify-between duration-300 hover:-translate-y-1 hover:shadow-md">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
              Our certificates are recognized by leading Fortune 500 companies
              and global engineering tech firms.
            </p>
          </div>
        </div>
        ...
        <div className="group bg-white dark:bg-slate-800/40 border border-gray-100 dark:border-slate-700/30 rounded-3xl p-8 shadow-xs flex flex-col justify-between duration-300 hover:-translate-y-1 hover:shadow-md">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
              Stay ahead of the curve with curriculum updated weekly to cover
              cutting-edge AI integrations, cloud architecture, and modern tech
              stacks.
            </p>
          </div>
        </div>
