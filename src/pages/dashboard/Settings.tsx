      ...
      <div className="bg-white dark:bg-[#16423C] border border-gray-200/60 dark:border-white/5 rounded-2xl shadow-sm dark:shadow-xl overflow-hidden divide-y divide-gray-100 dark:divide-white/5">
        ...
        <div className="p-6 space-y-4">
          <h3 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <MdPerson size={18} className="text-gray-400 dark:text-[#E2FB6C]" />{" "}
            Profile Details
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="text-[10px] font-bold text-gray-400 dark:text-[#6B8A85] uppercase block mb-1">
                Full Name
              </label>
              <input
                type="text"
        ...
        <div className="p-6 space-y-4">
          <h3 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <MdLock size={18} className="text-gray-400 dark:text-[#E2FB6C]" />{" "}
            Change Password
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        <div className="p-6 space-y-4">
          <h3 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <MdNotifications
              size={18}
              className="text-gray-400 dark:text-[#E2FB6C]"
            />{" "}
            Notifications
          </h3>
          <div className="space-y-3">
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                type="checkbox"
                defaultChecked
                className="rounded border-gray-300 text-[#16423C] focus:ring-[#16423C]"
              />
              <span className="text-xs text-gray-700 dark:text-gray-200 font-medium">
                Email notifications for new lessons & challenges
              </span>
            </label>
            <label className="flex items-center gap-3 cursor-pointer">
              <input
